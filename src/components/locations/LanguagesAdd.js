...
const LanguagesAdd = ({ visible, setVisible, selectedLanguages }) => {
  ...
  const formik = useFormik({
    ...
    initialValues: {
      nameEn: selectedLanguages ? selectedLanguages.name.en : "",
      nameAr: selectedLanguages ? selectedLanguages.name.ar : "",
    },
    validate: (data) => {
      const errors = {};
      if (!data.nameEn) {
    ...
    onSubmit: (data) => {
      ...
      if (selectedLanguages) {
        dispatch(
          updateLanguages({ id: selectedLanguages.id, data: languageData })
        )
          .unwrap()
          .then(() => {
        ...
        dispatch(createLanguages(languageData))
          .unwrap()
          .then(() => {
            dispatch(getLanguages());
            formik.resetForm();
