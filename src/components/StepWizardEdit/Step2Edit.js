...
const Step2 = ({
  ...
  const formik2 = useFormik({
    ...
    onSubmit: (values) => {
      ...
      if (formData.authQRCode === values.authQRCode) {
        delete updatedFormData.authQRCode;
      }
      ...
      if (file) {
        ...
        await UploadFiles(formData, {
          onSuccess: (response) => {
            ...
            formik2.setFieldValue("authQRCode", uploadedFile.i);
          },
        });
      }
    },
      ...
      <div className="grid ">
        ...
        <div className="col-12 md:col-12 lg:col-12">
          <ImageUpload
            ...
            image={image}
            imageValue={formik2.values.authQRCode}
